...
class CustomAdapter(private val context: Activity, private val brands:Array<String>, private val imgs:Array<Int>)
    :ArrayAdapter<String>(context, R.layout.custom_item, brands) {
